...
public class App {
	...
	public static void main(String[] args) {
		...
		System.out.println("Welcome to Calculator!\n"
				+ "It works as the simple one.\n"
				+ "Enter Number or Operations separately.\n"
				+ "Enter equal(=) to see the answer.\n"
				+ "Enter help to see more or off to end.");
